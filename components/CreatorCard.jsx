...
const CreatorCard = ({ rank, creatorImage, creatorName, creatorEths }) => (
  <div className="flex flex-col p-4 m-4 bg-white border min-w-190 minlg:min-w-249 dark:bg-nft-black-3 dark:border-nft-black-3 border-nft-gray-1 rounded-3xl">
    ...
    <div className="flex justify-center my-2">
      <div className="relative w-20 h-20 minlg:w-28 minlg:h-28">
        <Image className="object-cover rounded-full" src={creatorImage} fill alt={creatorName} />
